...
DEFINE_int32(hhwheel_timer_tick_interval, 1, "hhwheel timer default tick interval");
 ...
 */
int HHWheelTimer::DEFAULT_TICK_INTERVAL = FLAGS_hhwheel_timer_tick_interval;
