...
class CmdArguments(object):
    ...
    def __add_build_actions_arguments(self, parser):
        ...
        # add make in --native-builder flag @niuqing 
        parser.add_argument(
            '--native-builder', dest='native_builder',
            type=str, choices = ['scons', 'ninja', 'make'], default='',
        ...
        # add --makefile flag @niuqing
        parser.add_argument(
            '--makefile', dest='stop_after',
            action='store_const', const='generate',
            help='Generate customized Makefile.')
