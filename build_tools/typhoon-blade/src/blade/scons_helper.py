...
def setup_fbthrift_builders(top_env, build_dir, fbthrift_bin, fbthrift_templates, fbthrift_incs_str, fbthrift_py):
    ...
    fbthrift2_bld = SCons.Builder.Builder(action = MakeAction(
        '%s --python-compiler %s --gen mstch_cpp2:$FBOPTIONS -I . %s -I `dirname $SOURCE` --templates %s '
        '-o %s/`dirname $SOURCE` $SOURCE' % (
            fbthrift_bin, fbthrift_py, fbthrift_incs_str, fbthrift_templates, build_dir),
